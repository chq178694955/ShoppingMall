...
import com.king.sys.dto.SysResource;
import com.king.sys.dto.SysRole;
...
public class MyRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        if(user == null){
            ...
            SimpleAuthenticationInfo simpleAuthenticationInfo=new SimpleAuthenticationInfo(account,user.getPwd().toString(),getName());
